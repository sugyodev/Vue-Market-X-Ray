<template>
  <div id="app">
    <transition name="fade">
      <div v-if="isModalVisible">
        <div @click="onToggle" class="absolute bg-black opacity-70 inset-0 z-20 h-[1000px]"></div>
        <div
  ...
  <div class="wizard-page py-6 sm:px-12 px-1 w-full">
    ...
    <button
      class="hover:bg-green-700 text-white my-28 bg-[#449DD1] text-sm px-4 py-3.5 rounded-lg w-full text-base"
      @click="gocategory">
      Proceed
